...
USER_MANIFEST = {
    "CHECKPOINTS": [
        "getphat_v6.safetensors",
        "chroma-unlocked-v28.safetensors",  # keeping the original for backward compatibility
    ],
    "CLIP": [
...
class WeightsManifest:
    ...
    def _initialize_weights_map(self):
        ...
        # Add special GetPhat mapping
        weights_map["getphat_v6.safetensors"] = {
            "url": "https://huggingface.co/NSFW-API/GetPhat/resolve/main/getphat_v6.safetensors",
            "dest": "checkpoints",
        }
